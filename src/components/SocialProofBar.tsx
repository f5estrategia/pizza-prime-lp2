...
import seloAbf2026 from "@/assets/selo-abf-2026.png";
...
const badges = [
{ image: seloAbf2026, text: "ABF Excelência em Franchising · 2024, 2025 e 2026", alt: "Selo ABF de Excelência em Franchising 2026" },
  ...
  <section className="bg-brand-yellow py-10 border-y border-[#0E0E0E]/10">
    <div className="container mx-auto px-4">
      ...
      <motion.div key={i} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.1 }} className="flex flex-col items-center gap-3">
            ...
            <div className="bg-white rounded-2xl shadow-sm flex items-center justify-center h-40 w-40 p-4">
